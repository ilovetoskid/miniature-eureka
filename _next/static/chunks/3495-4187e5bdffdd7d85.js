  ...
  [3495],
  {
    ...
    3495: function (t, e, i) {
      ...
      let w = {
        ...
        T = {};
      for (let t in w) T[t] = { isEnabled: (e) => w[t].some((t) => !!e[t]) };
      var A = i(1741),
        S = i(5364);
      ...
      function tx(t, e, i, n) {
        for (let i in (tv(t, e, void 0, n), e.attrs))
              ...
              let i = this.node.getProps(),
                n = tB(
                  ...
                  (t, e) => {
                    ...
                    tM.Wi.update(() => {
                      r || tG(this.node.current, t.target)
                        ? i && i(t, e)
                        : n && n(t, e);
                    });
                  },
        ...
        startObserver() {
          ...
          return (function (t, e, i) {
            let n = (function ({ root: t, ...e }) {
              ...
              return (
                n[r] ||
                  (n[r] = new IntersectionObserver(t1, { root: t, ...e })),
                n[r]
              );
            })(e);
            return (
      ...
      let es = er(0.42, 0, 1, 1),
        ...
        ey = (t) => {
          ...
          return "string" == typeof t
            ? ((0, t4.k)(void 0 !== ev[t], `Invalid easing type '${t}'`), ev[t])
            : t;
        },
        ex = (t, e) => (i) =>
          !!(
            (q(i) && G.test(i) && i.startsWith(t)) ||
        ...
        eb = (t) => N(0, 255, t),
        ew = { ...$, transform: (t) => Math.round(eb(t)) },
        eT = {
          test: ex("rgb", "red"),
        ...
        eV = {
          ...
          parse: (t) =>
            eT.test(t) ? eT.parse(t) : eS.test(t) ? eS.parse(t) : eA.parse(t),
          transform: (t) =>
            q(t)
              ? t
      ...
      let eL = (t, e) => {
        ...
        eF = { regex: X, countKey: "Colors", token: "${c}", parse: eV.parse },
        eB = { regex: Y, countKey: "Numbers", token: "${n}", parse: $.parse };
      ...
      function eI(t) {
        ...
        return (t) => {
          ...
          for (let r = 0; r < s; r++)
            e =
              r < n
                ? e.replace(ej.token, t[r])
                : r < n + i
                ? e.replace(eF.token, eV.transform(t[r]))
                : e.replace(eB.token, z(t[r]));
          return e;
        };
      }
      ...
      let ez = (t, e) => {
        ...
        eX = (t, e) => {
          let i = e$.createTransformer(e),
            n = eU(t),
            r = eU(e);
          return n.numVars === r.numVars &&
            n.numColors === r.numColors &&
            n.numNumbers >= r.numNumbers
            ? tU(ez(n.values, r.values), i)
            : ((0, t4.K)(
                !0,
          ...
          o = eK(
            ...
            e,
            {
              ease: Array.isArray(r)
                ? r
                : e.map(() => r || ea).splice(0, e.length - 1),
            }
          );
        return {
      ...
      let e9 = { decay: e3, inertia: e3, tween: e_, keyframes: e_, spring: e2 };
      function e8({
        autoplay: t = !0,
        delay: e = 0,
        driver: i = e6,
              ...
              let i = (function (t, e, { onUpdate: i, onComplete: n, ...r }) {
                ...
                return (
                  ...
                  }),
                  {
                    then: (t, e) => o.then(t, e),
                    attachTimeline: (t) => (
                      (m.timeline = t), (m.onfinish = null), tq.Z
                    ),
                    get time() {
        ...
        constructor(t, e = {}) {
          (this.version = "10.18.0"),
            ...
            (this.scheduleVelocityCheck = () =>
              tM.Wi.postRender(this.velocityCheck)),
      ...
      function iF(t, e, { delay: i = 0, transitionOverride: n, type: r } = {}) {
        ...
        for (let e in a) {
          ...
          if (
            ...
            continue;
          let o = { delay: i, elapsed: 0, ...iy(s || {}, e) };
          ...
          if (
            ...
            continue;
          n.start(
            iP(e, n, r, t.shouldReduceMotion && R.has(e) ? { type: !1 } : o)
          );
          let d = n.animation;
                      ...
                      e.map(({ animation: e, options: i }) =>
                        (function (t, e, i = {}) {
                          ...
                          if ((t.notify("AnimationStart", e), Array.isArray(e)))
                            ...
                            let r =
                              "function" == typeof e ? t6(t, e, i.custom) : e;
        ...
        constructor(
          ...
          l && l(t, iG(s, this.history)),
            (this.removeListeners = tU(
              tB(this.contextWindow, "pointermove", this.handlePointerMove),
              tB(this.contextWindow, "pointerup", this.handlePointerUp),
              tB(this.contextWindow, "pointercancel", this.handlePointerUp)
            ));
        }
        updateHandlers(t) {
          this.handlers = t;
      ...
      function iG({ point: t }, e) {
        return {
          ...
          velocity: (function (t, e) {
            ...
            for (
              ;
              i >= 0 && ((n = t[i]), !(r.timestamp - n.timestamp > t9(0.1)));
      ...
      function i_(t, e = 0, i = 0.01) {
        return Math.abs(t - e) <= i;
      }
      function iJ(t, e, i, n = 0.5) {
        (t.origin = n),
      ...
      function i6(t, e, i) {
        return { min: i4(t, e), max: i4(t, i) };
      }
      function i4(t, e) {
        return "number" == typeof t ? t : t[e] || 0;
      }
      let i9 = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
        i8 = () => ({ x: i9(), y: i9() }),
        i7 = () => ({ min: 0, max: 0 }),
        nt = () => ({ x: i7(), y: i7() });
      function ne(t) {
      ...
      class nx {
        ...
        resolveConstraints() {
          ...
          e && m(e)
            ...
            ? (this.constraints = (function (
                ...
                return { x: i2(t.x, i, r), y: i2(t.y, e, n) };
              })(n.layoutBox, e))
            : (this.constraints = !1),
        ...
        resolveRefConstraints() {
          ...
          let s = (function (t, e, i) {
            ...
            o = { x: i3((t = r.layout.layoutBox).x, s.x), y: i3(t.y, s.y) };
          if (i) {
            let t = i(
              (function ({ x: t, y: e }) {
      ...
      let nA = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
      function nS(t, e) {
      ...
      function n2({
        ...
        return class {
          ...
          addEventListener(t, e) {
            return (
              this.eventHandlers.has(t) || this.eventHandlers.set(t, new iS()),
              ...
              t(e, () => {
                (this.root.updateBlockedByResize = !0),
                  ...
                  nA.hasAnimatedSinceResize &&
                    ((nA.hasAnimatedSinceResize = !1), this.nodes.forEach(ri));
              });
            }
          ...
          applyTransform(t, e = !1) {
            ...
            for (let t = 0; t < this.path.length; t++) {
              ...
              !e &&
                ...
                n.scroll &&
                n !== n.root &&
                nf(i, { x: -n.scroll.offset.x, y: -n.scroll.offset.y }),
                ...
                for (let a = 0; a < o; a++) {
                  ...
                  (!o || !o.style || "contents" !== o.style.display) &&
                    (n &&
                      ...
                      r.scroll &&
                      r !== r.root &&
                      nf(t, { x: -r.scroll.offset.x, y: -r.scroll.offset.y }),
                    s && ((e.x *= s.x.scale), (e.y *= s.y.scale), nu(t, s)),
                  ...
                  (function (t, e, i, n, r, s) {
                    ...
                    for (let r = 0; r < nk; r++) {
                      ...
                      (void 0 !== o || void 0 !== a) &&
                        ...
                        a || (a = 0),
                        0 === o || 0 === a || nL(o) === nL(a)
                          ? ((t[s] = Math.max(eE(nR(o), nR(a), n), 0)),
                            (J.test(a) || J.test(o)) && (t[s] += "%"))
                          : (t[s] = a));
                    }
                    (e.rotate || i.rotate) &&
          ...
          getProjectionStyles(t) {
            ...
            if (this.needsReset)
              return (
                ...
                (n.opacity = ""),
                (n.pointerEvents =
                  tE(null == t ? void 0 : t.pointerEvents) || ""),
      ...
      let rh = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
        rc = (t) =>
      ...
      function rm(t, e, i) {
        return (
          "position" === t ||
          ("preserve-aspect" === t && !i_(nG(e), nG(i), 0.2))
        );
      }
      let rf = n2({
      ...
      let rM = (t, e, i) => {
        ...
        rD = (t, e, i = {}, n = {}) => {
            ...
            return { target: e, transitionEnd: n };
          {
            ...
            return (
              ...
              t.render(),
              A.j && null !== i && window.scrollTo({ top: i }),
        ...
        rk = (t, e, i, n) => {
          ...
          return (
            ...
            (r = e),
            (s = n),
            rw(r) ? rD(t, r, i, s) : { target: r, transitionEnd: s }
          );
        },
        rR = { current: null },
        rL = { current: !1 },
      ...
      class rW {
          ...
          (this.prevMotionValues = (function (t, e, i) {
            ...
            for (let r in e) {
              ...
              if (j(s)) t.addValue(r, s), ib(n) && n.add(r);
                ...
                t.addValue(r, iM(s, { owner: t })), ib(n) && n.remove(r);
              else if (o !== s) {
                if (t.hasValue(r)) {
                  let e = t.getValue(r);
                  ...
                  t.addValue(r, iM(void 0 !== e ? e : s, { owner: t }));
                }
              }
            }
        ...
        getValue(t, e) {
          ...
          return (
            void 0 === i &&
              void 0 !== e &&
              ((i = iM(e, { owner: this })), this.addValue(t, i)),
            i
          );
        }
        readValue(t) {
        ...
        on(t, e) {
          return (
            this.events[t] || (this.events[t] = new iS()), this.events[t].add(e)
          );
        }
        notify(t, ...e) {
                    ...
                    null === u &&
                      (u =
                        null !==
                          ...
                          : e[o]),
                    null != u &&
                      ("string" == typeof u && (iw(u) || iv(u))
                        ? (u = parseFloat(u))
                        : !ij(u) && e$.test(l) && (u = ig(o, l)),
                      t.addValue(o, iM(u, { owner: t })),
                      void 0 === i[o] && (i[o] = u),
      ...
      let rH = (t, e) =>
          M(t)
            ? new r$(e, { enableHardwareAcceleration: !1 })
            : new rN(e, { enableHardwareAcceleration: !0 }),
        rZ = {
          ...
          hover: { Feature: tY },
          pan: { Feature: nT },
          drag: { Feature: nb, ProjectionNode: rv, MeasureLayout: nC },
          layout: { ProjectionNode: rv, MeasureLayout: nC },
        },
        rz = (function (t) {
          function e(e, i = {}) {
            return (function ({
                ...
                if (!P && A.j) {
                  w.visualElement = (function (t, e, i, n) {
                    let { visualElement: r } = (0, o.useContext)(l),
                      ...
                      m = (0, o.useContext)(a).reducedMotion,
                      f = (0, o.useRef)();
                    (n = n || s.renderer),
                      !f.current &&
                        n &&
                  ...
                  w.visualElement &&
                    (v = w.visualElement.loadFeatures(y, n, t, i));
                }
