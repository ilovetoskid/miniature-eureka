  ...
  [1664],
  {
    ...
    9577: function (e, t, n) {
      ...
      let O = u.default.forwardRef(function (e, t) {
        ...
        u.default.useEffect(() => {
          S && z && U && _(S, K, F, { locale: M }, { kind: w }, N);
        ...
        if ((0, c.isAbsoluteUrl)(F)) Y.href = F;
          ...
          Y.href =
            t ||
            (0, b.addBasePath)(
              (0, i.addLocale)(F, e, null == x ? void 0 : x.defaultLocale)
            );
        }
        return k
          ? u.default.cloneElement(r, Y)
          : (0, o.jsx)("a", { ...I, ...Y, children: n });
      });
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
