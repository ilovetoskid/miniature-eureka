    ...
    5887: function (e, t, r) {
      ...
      function d(e) {
        ...
        return n.createElement(
          n.Fragment,
          null,
          r(l({ copy: () => s.copy(i), copied: s.copied }, u))
        );
      }
            ...
            (this.nextBreak = function (r, n) {
              ...
              for (var o = t(e(r, n)), a = [], i = n + 1; i < r.length; i++)
                if (
                  ((u = i - 1),
                  !(
                    55296 <= r.charCodeAt(u) &&
                    56319 >= r.charCodeAt(u) &&
                    56320 <= r.charCodeAt(u + 1) &&
                    57343 >= r.charCodeAt(u + 1)
                  ))
                ) {
                  var u,
                    s = t(e(r, i));
                    ...
                    (function (e, t, r) {
                      ...
                      var u =
                        -1 != n.indexOf(3)
                          ? n.lastIndexOf(3) - 1
                          : n.length - 2;
                      return (-1 != [13, 17].indexOf(n[u]) &&
                        n.slice(u + 1, -1).every(function (e) {
                          return 3 == e;
                        }) &&
                        14 == r) ||
          ...
          return (function e(a, i) {
            ...
            if (a && i && "object" == typeof a && "object" == typeof i) {
              ...
              if (Array.isArray(a)) {
                ...
                for (s = u; 0 != s--; ) if (!e(a[s], i[s])) return !1;
                return !0;
              }
              ...
              if (o && ArrayBuffer.isView(a) && ArrayBuffer.isView(i)) {
                if ((u = a.length) != i.length) return !1;
                for (s = u; 0 != s--; ) if (a[s] !== i[s]) return !1;
                return !0;
              }
      ...
      var b = {
              ...
              r.filter(function (e) {
                for (
                  ...
                  var u = a[i],
                    s = u.toLowerCase();
                  -1 === t.indexOf(s) ||
                    (r === b.REL && "canonical" === e[r].toLowerCase()) ||
                    (s === b.REL && "stylesheet" === e[s].toLowerCase()) ||
                    (r = s),
                    -1 !== t.indexOf(u) &&
                      (u === b.INNER_HTML ||
                        u === b.CSS_TEXT ||
        ...
        U = function (e, t) {
          ...
          if (r) {
            ...
            o.length === a.length
              ? r.removeAttribute(_)
              : r.getAttribute(_) !== i.join(",") &&
                r.setAttribute(_, i.join(","));
          }
        },
        q = function (e, t) {
        ...
        K = function (e) {
          ...
          return {
            ...
            title: $(
              m.TITLE,
              { title: void 0 === l ? "" : l, titleAttributes: f },
              n
            ),
          };
        },
          ...
          ((o = l()(
            function (e) {
              ...
              return {
                ...
                metaTags: N(
                  m.META,
                  [b.NAME, b.CHARSET, b.HTTPEQUIV, b.PROPERTY, b.ITEM_PROP],
                  e
                ),
                noscriptTags: N(m.NOSCRIPT, [b.INNER_HTML], e),
                onChangeClientState:
                  D(e, "onChangeClientState") || function () {},
              ...
              return (
                ...
                (t.prototype.flattenArrayTypeChildren = function (e) {
                  ...
                  return x(
                    ...
                    (((t = {})[r.type] = [].concat(n[r.type] || [], [
                      x({}, o, this.mapNestedChildrenToProps(r, a)),
                    ])),
                    t)
                  );
                }),
                (t.prototype.mapObjectTypeChildren = function (e) {
                  ...
                  switch (n.type) {
                    ...
                    case m.BODY:
                      return x({}, o, { bodyAttributes: x({}, a) });
                    case m.HTML:
                      return x({}, o, { htmlAttributes: x({}, a) });
                  }
        ...
        return function (u) {
          ...
          return (
            a(
              f,
              "displayName",
              "SideEffect(" + (u.displayName || u.name || "Component") + ")"
            ),
            a(f, "canUseDOM", i),
            f
          );
                              ...
                              switch (
                                ...
                                case u:
                                  ...
                                  g.options.onCreateTextNode &&
                                    ...
                                    (j = g.options.onCreateTextNode(E, x)),
                                    j &&
                                      (S
                                        ? S.appendChild(j)
                                ...
                                case p:
                                  var C = a.eventArgs,
                                    P = C.cb,
                                    M = C.thisArg;
                                  P.call(M, { elements: g.state.elements });
                                  break;
                                case d:
                                  var k = a.eventArgs,
                                    N = k.node,
                                  ...
                                  D
                                    ? D.appendChild(N)
                                    : g.state.elements.wrapper.appendChild(N),
                                    (g.state.visibleNodes = [].concat(
                                      _(g.state.visibleNodes),
                                      [
                                        {
